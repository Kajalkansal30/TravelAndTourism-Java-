...
//	JLabel caption;
//	public void run() {
//		String[] text= new String[] {"JW Marriot Hotel","Madarin Hotel","Four Season Hotel","Radisson Hotel","Great Grand ITC","Classio Hotel","The Bay Club Hotel","Breeze Blow Hotel","The Taj Hotel"};
//		try {
//			for(int i = 0;i<9;i++) {
